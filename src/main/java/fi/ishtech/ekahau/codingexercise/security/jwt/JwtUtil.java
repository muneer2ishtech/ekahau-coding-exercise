package fi.ishtech.ekahau.codingexercise.security.jwt;
...
import fi.ishtech.ekahau.codingexercise.payload.JwtResponse;
import fi.ishtech.ekahau.codingexercise.security.userdetails.UserDetailsImpl;
...
public class JwtUtil {
	...
	@Value("${fi.istech.ekahau.jwt.secret}")
	private String jwtSecret;

	@Value("${fi.istech.ekahau.jwt.experition-ms}")
	private Integer jwtExpirationMs;

	private static final String issuer = "ekahau.ishtech.fi";
